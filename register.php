					...
					<div class="row align-items-center justify-content-center">
						...
						<div class="col-md-12 col-lg-6 login-right">
							<div class="login-header">
								<h3>Patient Registration <a href="doctor-register.php">Are you a Doctor?</a></h3>
							</div>
							<!-- Register Form -->
							<form method="POST">
								...
								<button class="btn btn-rounded btn-primary btn-block btn-lg login-btn" id="registerBtn" type="submit" name="register" disabled>Sign Up</button>
							</form>
							<!-- /Register Form -->
