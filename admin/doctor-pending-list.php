		...
		<div class="page-header">
			<div class="row">
				<div class="col-sm-7 col-auto">
					<h3 class="page-title">List of Pending Doctors</h3>
					<!-- <ul class="breadcrumb">
				...
				<!-- <div class="col-sm-5 col">
					<div class="mt-2">
						<form method="post" action="assets/patients_generate_by_appt_csv.php">
							<button type="submit" name="patients_generate_file" class="btn btn-rounded btn-primary float-right" style="margin: 5px;">Generate by Appointments</button>
						</form>
					</div>
					<div class="mt-2">
						<form method="post" action="assets/patients_generate_csv.php">
							<button type="submit" name="patients_generate_file" class="btn btn-rounded btn-primary float-right" style="margin: 5px;">Generate File</button>
						</form>
					</div>
				</div> -->
			</div>
							...
							<div class="table-responsive">
								<table class="datatable table table-hover table-center mb-0">
									...
									<tbody>
										...
										$patientQuery = "SELECT * FROM users WHERE usertype = 'register_doctor'";
