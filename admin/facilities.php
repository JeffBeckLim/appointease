		...
		<div class="page-header">
			<div class="row">
				...
				<div class="col-sm-5 col">
					<a href="#Add_Facilities_details" data-toggle="modal" class="btn btn-rounded btn-primary float-right mt-2">Add</a>
				</div>
			</div>
		</div>
		<!-- /Page Header -->
									...
									?>
											<tr>
												<td>
													<h2 class="table-avatar">
														<a href="#" class="avatar avatar-sm mr-2">
															<img class="avatar-img" src="<?php echo $facilityIcon; ?>" alt="<?php echo $facilityName; ?>">
														</a>
												...
												<td class="text-center">
													<div class="actions">
														<a data-toggle="modal" href="#delete_modal" class="btn btn-sm bg-danger-light delete_facility" data-facility-id='<?php echo $facilityId;?>'>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="addFacilitiesForm">
                    ...
                    <button type="button" class="btn btn-rounded btn-primary btn-block" onclick="addFacilities()">Save Changes</button>
                </form>
            </div>
        </div>
    </div>
