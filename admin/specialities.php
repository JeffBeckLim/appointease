		...
		<div class="page-header">
			<div class="row">
				...
				<div class="col-sm-5 col">
					<a href="#Add_Service_details" data-toggle="modal" class="btn btn-rounded btn-primary float-right mt-2">Add</a>
				</div>
			</div>
		</div>
		<!-- /Page Header -->
											...
											<tr>
												<td>
													<h2 class="table-avatar">
														<a href="#" class="avatar avatar-sm mr-2">
															<img class="avatar-img" src="<?php echo $serviceIcon; ?>" alt="<?php echo $serviceName; ?>">
														</a>
												...
												<td class="text-center">
													<div class="actions">
														...
														<a href="#" class='btn btn-sm bg-info-light edit_service' data-service-id='<?php echo $serviceId; ?>' data-service-name='<?php echo $serviceName; ?>' data-service-specialties='<?php echo $specialty; ?>'>
															<i class='fe fe-pencil'></i> Edit
														</a>
														&nbsp;
														<a href="#delete_modal" class="btn btn-sm bg-danger-light delete_service" data-toggle="modal" data-service-id='<?php echo $serviceId; ?>'>
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				<form id="addServiceForm">
					...
					<button type="button" class="btn btn-rounded btn-primary btn-block" onclick="addService()">Save Changes</button>
				</form>
			</div>
		</div>
	</div>
				...
				<form id="editServiceForm">
					<div class="row form-row">
						...
						<div class="col-12 col-sm-6">
							<div class="form-group">
								<label>Picture</label>
								<input type="file" class="form-control" name="serviceIcon" id="editServiceIcon" required>
							</div>
						</div>
					</div>
					<div class="form-group mb-0">
					...
					<button type="button" class="btn btn-rounded btn-primary btn-block" onclick="updateService()">Save Changes</button>
				</form>
			</div>
		</div>
	</div>
