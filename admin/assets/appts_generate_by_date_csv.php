...
$appointmentQuery = "SELECT a.*, du.fname AS doctor_fname, du.lname AS doctor_lname, u.fname AS patient_fname, u.lname AS patient_lname
                    ...
                    ORDER BY CONCAT(du.fname, ' ', du.lname) ASC, a.appointment_date ASC";
...
header('Content-Disposition: attachment;filename="appointments_by_date_export.csv"');
...
fputcsv($output, array('Appointments by Date', '', '', '', '', '', ''), ',', ' ');
