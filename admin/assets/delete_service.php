...
// Check if the service ID is provided in the POST request
if (isset($_POST['currentServiceId'])) {

    $serviceId = $_POST['currentServiceId'];
    ...
    // If service ID is not provided, send an error response
    $response = ['success' => false, 'error' => 'Service ID not provided'];
}
