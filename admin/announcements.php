        ...
        <div class="page-header">
            <div class="row">
                ...
                <div class="col-sm-5 col">
                    <a href="#Add_announcements_details" data-toggle="modal"
                                        ...
                                        <td>
                                            <h2 class="table-avatar">
                                                <a href="#" class="avatar avatar-sm mr-2">
                                                    <img class="avatar-img" src="<?php echo $announcementIcon; ?>"
                                                        alt="<?php echo $announcementName; ?>">
                                                </a>
                                        ...
                                        <td class="text-center">
                                            <div class="actions">
                                                <a data-toggle="modal" href="#delete_modal"
                                                    class="btn btn-rounded btn-sm bg-danger-light delete_announcement"
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="addannouncementsForm">
                    ...
                    <button type="button" class="btn btn-rounded btn-primary btn-block"
                        onclick="addannouncements()">Save Changes</button>
                </form>
            </div>
        </div>
    </div>
        ...
        <div class="modal-content">
            <div class="modal-body">
                <div class="form-content p-2">
                    ...
                    <button type="button" class="btn btn-rounded btn-primary" id="deleteannouncementButton">Yes
                    </button>
