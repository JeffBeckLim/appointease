                    ...
                    <div class="footer-widget footer-about">
                        ...
                        <div class="footer-about-content">
                            ...
                            <div class="social-icon">
                                <ul>
                                    <li>
                                        <a href="https://legazpi.gov.ph/health/" target="_blank"><i class="fas fa-landmark"></i></a>
                                    </li>
                                </ul>
                            </div>
                        </div>
                ...
                ?>
                        <div class="col-lg-3 col-md-6">
                            <div class="footer-widget footer-menu">
                                ...
                                <ul>
                                    <li><a href="patient-dashboard.php?page=patients&sub=patdash"><i class="fas fa-angle-double-right"></i> Patient Dashboard</a></li>
                                    <li><a href="search.php?page=patients&sub=searchdoc"><i class="fas fa-angle-double-right"></i> Search for Doctors</a></li>
                                </ul>
                            </div>
                        </div>
                    <?php
                    ...
                    ?>
                        <div class="col-lg-3 col-md-6">
                            <div class="footer-widget footer-menu">
                                ...
                                <ul>
                                    <li><a href="doctor-dashboard.php?page=doctor&sub=dashboard"><i class="fas fa-angle-double-right"></i> Doctor Dashboard</a></li>
                                    <li><a href="schedule-timings.php?page=doctor&sub=sched"><i class="fas fa-angle-double-right"></i> Schedule Timing</a></li>
                                    <li><a href="my-patients.php?page=doctor&sub=patients"><i class="fas fa-angle-double-right"></i> Patients List</a></li>
                                    <li><a href="reviews.php?page=doctor&sub=reviews"><i class="fas fa-angle-double-right"></i> Reviews</a></li>
                                </ul>
                            </div>
                        </div>
                <?php
                        ...
                        <div class="row form-row">
                            <div class="col-12 col-md-4">
                                <div class="form-group">
                                    ...
                                    <div class="input-group date" id="add_doctor_schedule_start_time" data-target-input="nearest">
                                        <input type="text" id="viewBookStartTime" name="view_book_start_time" class="form-control datetimepicker-input" data-target="#view_book_start_time" required onkeydown="return false" onpaste="return false;" ondrop="return false;" autocomplete="off" />
                                    </div>
                                </div>
                            </div>
                            <div class="col-12 col-md-4">
                                <div class="form-group">
                                    ...
                                    <div class="input-group date" id="add_doctor_schedule_start_time" data-target-input="nearest">
                                        <input type="text" id="viewBookDuration" name="view_book_duration" class="form-control datetimepicker-input" data-target="#view_book_duration" required onkeydown="return false" onpaste="return false;" ondrop="return false;" autocomplete="off" />
                                    </div>
                                </div>
                            </div>
                            <div class="col-12 col-md-4">
                                <div class="form-group">
                                    ...
                                    <div class="input-group date" id="add_doctor_schedule_start_time" data-target-input="nearest">
                                        <input type="text" id="viewBookDate" name="view_book_date" class="form-control datetimepicker-input" data-target="#view_book_date" required onkeydown="return false" onpaste="return false;" ondrop="return false;" autocomplete="off" />
                                    </div>
                                </div>
                            </div>
                            <div class="col-12">
                            ...
                            <div class="col-16 col-md-12">
                                <div class="form-group">
                                    ...
                                    <div class="input-group date" id="add_doctor_schedule_start_time" data-target-input="nearest">
                                        <textarea id="viewBookReason" name="view_book_reason" class="form-control" rows="2" required style="resize: none;" readonly></textarea>
                                    </div>
                                </div>
                            </div>
                            <div class="col-16 col-md-12">
                                <div class="form-group">
                                    ...
                                    <div class="input-group date" id="add_doctor_schedule_start_time" data-target-input="nearest">
                                        <textarea id="viewBookComment" name="view_book_comment" class="form-control" rows="3" required style="resize: none;"></textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="submit-section text-center">
                            <button type="button" class="btn btn-rounded btn-primary submit-btn" id="completeBookingButton">Complete</button>
                            <button type="button" class="btn btn-rounded btn-primary submit-btn" id="confirmBookingButton">Confirm</button>
                            &nbsp;
                            <button type="button" class="btn btn-rounded btn-danger submit-btn" id="cancelBookingButton">Cancel</button>
                        </div>
                    </form>
                </div>
            </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            $(document).on('click', '.view_booking', function() {
                ...
                var viewBookReason = $(this).closest('tr').find('td[data-appointment-reason]').data('appointment-reason');
                ...
                if (specialties) {
                    ...
                    $.each(specialtiesArray, function(index, specialty) {
                        specialtiesContainer.append('<div class="col-6">' +
                            ...
                            '<input class="form-check-input" type="checkbox" value="' + specialty + '" name="doctorSpecialties[]" id="doctorSpecialty' + specialty + '" checked disabled>' +
                            '<label class="form-check-label" for="doctorSpecialty' + specialty + '">' + specialty + '</label>' +
                            '</div>' +
                            '</div>');
                    });
                } else {
    ...
    <script>
        ...
        document.getElementById('printPDF').addEventListener('click', function() {
            ...
            if (selectedDate !== '') {
                ...
                window.location.href = 'assets/pdf-doctor-dashboard.php?appointment_date=' + selectedDate + '&user_id=' + user_id;
            } else {
                        ...
                        <div class="row form-row">
                            <div class="col-12 col-md-4">
                                <div class="form-group">
                                    ...
                                    <div class="input-group date" id="add_doctor_schedule_start_time" data-target-input="nearest">
                                        <input type="text" id="bookStartTime" name="book_time_slot_start_time" class="form-control datetimepicker-input" data-target="#book_time_slot_start_time" required onkeydown="return false" onpaste="return false;" ondrop="return false;" autocomplete="off" />
                                    </div>
                                </div>
                            </div>
                            <div class="col-12 col-md-4">
                                <div class="form-group">
                                    ...
                                    <div class="input-group date" id="add_doctor_schedule_start_time" data-target-input="nearest">
                                        <input type="text" id="bookDuration" name="book_time_slot_end_time" class="form-control datetimepicker-input" data-target="#book_time_slot_duration" required onkeydown="return false" onpaste="return false;" ondrop="return false;" autocomplete="off" />
                                    </div>
                                </div>
                            </div>
                            <div class="col-12 col-md-4">
                                <div class="form-group">
                                    ...
                                    <div class="input-group date" id="add_doctor_schedule_start_time" data-target-input="nearest">
                                        <input type="text" id="bookDate" name="book_doctor_schedule_date" class="form-control datetimepicker-input" data-target="#book_time_slot_date" required onkeydown="return false" onpaste="return false;" ondrop="return false;" autocomplete="off" />
                                    </div>
                                </div>
                            </div>
                            <div class="col-12">
                            ...
                            <div class="col-16 col-md-12">
                                <div class="form-group">
                                    ...
                                    <div class="input-group date" id="add_doctor_schedule_start_time" data-target-input="nearest">
                                        <textarea id="bookReason" name="book_time_slot_reason" class="form-control" rows="4" required style="resize: none;"></textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="submit-section text-center">
                            <button type="button" class="btn btn-rounded btn-primary submit-btn" id="bookTimeSlotButton">Book Timeslot</button>
                        </div>
                    </form>
                </div>
            </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#bookTimeSlotButton').click(function() {
                ...
                // Send the data to the server for processing
                bookTimeSlotDatabase(doctorid, userid, currentScheduleId, bookStartTime, bookDuration, bookDate, bookReason, doctorSpecialties);
            });

            //Function to send data to the server for adding a new time slot
            function bookTimeSlotDatabase(doctorid, userid, currentScheduleId, bookStartTime, bookDuration, bookDate, bookReason, doctorSpecialties) {
                $.ajax({
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="addTimeSlotForm">
                        ...
                        <div class="row form-row">
                            <div class="col-12 col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="input-group date" id="add_doctor_schedule_start_time" data-target-input="nearest">
                                        <div class="input-group-prepend" data-target="#add_doctor_schedule_start_time" data-toggle="datetimepicker">
                                            <span class="input-group-text" id="basic-addon1"><i class="fas fa-clock"></i></span>
                                        </div>
                                        <input type="text" id="addStartTime" name="add_doctor_schedule_start_time" class="form-control datetimepicker-input" data-target="#add_doctor_schedule_start_time" required onkeydown="return false" onpaste="return false;" ondrop="return false;" autocomplete="off" />
                                    </div>
                                </div>
                            </div>
                            <div class="col-12 col-md-6">
                        ...
                        <div class="submit-section text-center">
                            <button type="button" class="btn btn-rounded btn-primary submit-btn" id="addTimeSlotButton">Add Timeslot</button>
                        </div>
                    </form>
                </div>
            </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#addTimeSlotButton').click(function() {
                ...
                // Send the data to the server for processing
                addTimeSlotToDatabase(doctorid, selectedday, selectedStartTime, selectedEndTime, selectedDuration);
            });
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="editTimeSlotForm">
                                    ...
                                    <div class="row form-row">
                                        <div class="col-12 col-md-6">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group date" id="edit_doctor_schedule_start_time" data-target-input="nearest">
                                                    <div class="input-group-prepend" data-target="#edit_doctor_schedule_start_time" data-toggle="datetimepicker">
                                                        <span class="input-group-text" id="basic-addon1"><i class="fas fa-clock"></i></span>
                                                    </div>
                                                    <input type="text" id="editStartTime" name="edit_doctor_schedule_start_time" class="form-control datetimepicker-input" data-target="#edit_doctor_schedule_start_time" required onkeydown="return false" onpaste="return false;" ondrop="return false;" autocomplete="off" />
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-12 col-md-6">
                        ...
                        <div class="submit-section text-center">
                            <button type="button" class="btn btn-rounded btn-primary submit-btn" id="editsaveChangesButton">Save Changes</button>
                        </div>
                    </form>
                </div>
            </div>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-rounded btn-danger" id="confirmCancelAppointment">Cancel Appointment</button>
                </div>
            </div>
        </div>
    </div>
                ...
                <form id="medicalRecordsForm" enctype="multipart/form-data">
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="recordDescription" id="recordDescription" maxlength="100"></textarea>
                        ...
                        <div class="submit-section text-center">
                            <button type="button" class="btn btn-rounded btn-primary submit-btn" id="recordAdd">Submit</button>
                            <button type="button" class="btn btn-rounded btn-secondary submit-btn" data-dismiss="modal">Cancel</button>
                        </div>
                    </div>
                </form>
            </div>
                ...
                <form id="medicalRecordsFormEdit" enctype="multipart/form-data">
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control" name="editrecordDescription" id="editrecordDescription" maxlength="100"></textarea>
                            <small class="form-text text-muted"><strong>100</strong> characters only</small>
                        </div>
                        <div class="form-group">
                            <label for="recordInput">Upload File</label>
                        ...
                        <div class="submit-section text-center">
                            <button type="button" class="btn btn-rounded btn-primary submit-btn" id="recordEdit">Submit</button>
                            <button type="button" class="btn btn-rounded btn-secondary submit-btn" data-dismiss="modal">Cancel</button>
                        </div>
                    </div>
                </form>
    ...
    <div class="modal fade" id="greetingModal" tabindex="-1" role="dialog" aria-labelledby="greetingModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p>As first time user, we would like to get to know about your health background.<br><br><b>Please fill up the information below.</b></p>
                </div>
                <div class="modal-footer">
