    ...
    $(".add-hours").on('click', function () {
		...
		var hourscontent = '<div class="row form-row hours-cont">' +
			'<div class="col-12 col-md-10">' +
				...
				'</div>' +
			'</div>' +
			'<div class="col-12 col-md-2"><label class="d-md-block d-sm-none d-none">&nbsp;</label><a href="#" class="btn btn-rounded btn-danger trash"><i class="far fa-trash-alt"></i></a></div>' +
		'</div>';
