    ...
    $(".add-education").on('click', function () {
		...
		var educationcontent = '<div class="row form-row education-cont">' +
			'<div class="col-12 col-md-10 col-lg-11">' +
				...
				'</div>' +
			'</div>' +
			'<div class="col-12 col-md-2 col-lg-1"><label class="d-md-block d-sm-none d-none">&nbsp;</label><a href="#" class="btn btn-rounded btn-danger trash"><i class="far fa-trash-alt"></i></a></div>' +
		'</div>';
    ...
    $(".add-award").on('click', function () {
        ...
        var regcontent = '<div class="row form-row awards-cont">' +
			...
			'<div class="col-12 col-md-2">' +
				...
				'<a href="#" class="btn btn-rounded btn-danger trash"><i class="far fa-trash-alt"></i></a>' +
			'</div>' +
		'</div>';
